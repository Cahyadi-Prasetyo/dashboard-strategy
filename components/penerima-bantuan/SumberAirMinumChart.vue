            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h4 class="font-bold text-gray-800 text-sm">
                        Jumlah Keluarga Terdampak Menurut Daerah, Kondisi Sumber Air Minum Utama, dan Jenis Hunian yang
            ...
            <div class="flex items-start gap-2">
                ...
                <div class="text-xs text-blue-800">
                    ...
                    <p>
                        ...
                        berdasarkan kondisi sumber air minum utama (layak digunakan dan tidak layak digunakan).
                    </p>
                </div>
            </div>
        </div>
...
const jenisHunianOptions = [
    {
        ...
        prefix: "rumah_tinggal",
    },
    {
        value: "rumah_tinggal_keluarga_besar",
        label: "Rumah tinggal keluarga besar",
        icon: "i-heroicons-square-2-stack",
        prefix: "rumah_tinggal_keluarga_besar",
    },
    {
        value: "pengungsian",
        label: "Pengungsian",
    ...
    {
        value: "rumah_tumpangan",
        label: "Rumah tumpangan",
        icon: "i-heroicons-squares-2x2",
        prefix: "rumah_tumpangan",
    },
    {
...
const currentIndicators = computed(() => {
    ...
    return [
        `air_minum_layak_${prefix}`,
        `air_minum_tidak_layak_${prefix}`,
    ];
});
...
const chartSeries = computed(() => {
    ...
    return [
        {
            name: "Layak Digunakan",
            data: dataPerWilayah.value.map(
                (w) => w[`air_minum_layak_${prefix}`] || 0,
            ),
            color: "#10B981", // Green
        },
        {
            name: "Tidak Layak Digunakan",
            data: dataPerWilayah.value.map(
                (w) => w[`air_minum_tidak_layak_${prefix}`] || 0,
            ),
            color: "#EF4444", // Red
        },
    ];
