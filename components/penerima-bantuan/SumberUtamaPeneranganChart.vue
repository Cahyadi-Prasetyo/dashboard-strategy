            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h4 class="font-bold text-gray-800 text-sm">
                        Jumlah Keluarga Terdampak Menurut Daerah, Kondisi Sumber Utama Penerangan, dan Jenis Hunian yang
                        Ditempati Setelah Bencana
                    </h4>
            ...
            <div class="flex items-start gap-2">
                ...
                <div class="text-xs text-blue-800">
                    ...
                    <p>
                        ...
                        berdasarkan kondisi sumber utama penerangan (listrik dan menyala sepanjang hari, listrik dan
                        menyala
                        tidak sepanjang hari, bukan listrik).
                    </p>
                </div>
            </div>
        </div>
...
const currentIndicators = computed(() => {
    ...
    return [
        `${prefix}_listrik_nyala_sepanjang_hari`,
        `${prefix}_listrik_nyala_tidak_sepanjang_hari`,
        `${prefix}_bukan_listrik`,
    ];
});
...
const chartSeries = computed(() => {
    ...
    return [
        {
            name: "Listrik dan Menyala Sepanjang Hari",
            data: dataPerWilayah.value.map(
                (w) => w[`${prefix}_listrik_nyala_sepanjang_hari`] || 0,
            ),
            color: "#10B981", // Green
        },
        {
            name: "Listrik Tapi Tidak Menyala Sepanjang Hari",
            data: dataPerWilayah.value.map(
                (w) => w[`${prefix}_listrik_nyala_tidak_sepanjang_hari`] || 0,
            ),
            color: "#F59E0B", // Amber
        },
        {
