<template>
    <section
        class="relative min-h-96 bg-cover bg-center flex items-center overflow-hidden"
        style="background-image: url(&quot;/images/hero-bg.png&quot;)"
    >
        <div class="absolute inset-0 bg-gray-900/90"></div>

        <div class="relative z-10 w-full px-6 lg:px-15 py-16 lg:py-20">
            <div class="max-w-full mx-auto text-center space-y-6">
                <p
                    class="text-yellow-400 font-medium tracking-wider uppercase text-sm"
                >
                    Tentang Dashboard
                </p>
                ...
                <p
                    class="text-gray-200 text-lg leading-relaxed max-w-6xl mx-auto"
                >
                    <!-- Dashboard terpadu pasca bencana Sumatera untuk alat
