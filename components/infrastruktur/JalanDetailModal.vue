...
// Tabs
const tabs = [
    { label: 'Jalan Nasional', key: 'Jalan Nasional' },
    { label: 'Jalan Provinsi', key: 'Jalan Provinsi' },
    { label: 'Jalan Kabupaten', key: 'Jalan Kabupaten' },
];
...
const processedData = computed(() => {
    ...
    const currentJenisJalan = tabs[activeTab.value].key;
    const groupedMap = new Map();

    rawRecords.value.forEach((r) => {
        // Filter by current tab
        if (r.itemCategory2?.nama !== currentJenisJalan) return;
